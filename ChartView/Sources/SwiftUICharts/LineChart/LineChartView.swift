...
public struct LineChartView: View {
    ...
    @State private var font_value: Double = 12.5
    @State private var chart_height: Double = 180.0
        ...
        ZStack(alignment: .center){
            Text("")
                ...
                if (UIScreen.main.bounds.height == 736.0){
                    ...
                    self.font_value = 14.5
                }
                    
                if (UIScreen.main.bounds.height == 812.0){
                    self.chart_height = 230
            ...
            RoundedRectangle(cornerRadius: 20)
                ...
                .frame(width: frame.width, height: self.chart_height, alignment: .center)
