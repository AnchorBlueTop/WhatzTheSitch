            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                ZStack{
                    GeometryReader{ reader in
                        ...
                        Line(data: self.data,
                             frame: .constant(CGRect(x: 0, y: 0, width: reader.frame(in: .local).width - 44.4, height: reader.frame(in: .local).height + 25)),
                             touchLocation: self.$indicatorLocation,
                             showIndicator: self.$hideHorizontalLines,
                             minDataValue: .constant(nil),
                             maxDataValue: .constant(nil),
                             showBackground: false,
                             gradient: GradientColor(start: Color("Magenta"), end: Color("Pink"))
                        )
                        .offset(x: 30, y: 0)
                        .onAppear(){
